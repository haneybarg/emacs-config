...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (spinner wakatime-mode lsp-java rust-mode undo-tree rainbow-mode helm-spotify-plus latex-preview-pane togetherly htmlize ledger-mode transpose-frame multiple-cursors ace-jump-mode expand-region intero lsp-python projectile cquery pdf-tools ox-reveal calfw-org calfw dired-quick-sort dired-ranger magit company-lsp lsp-ui lsp-mode flycheck use-package try powerline helm doom-themes company))))
(custom-set-faces
